      ...
      <section id="login">
        <div className="flex w-full flex-col-reverse lg:flex-row lg:items-center lg:justify-between">
          <div className="h-screen px-4 pt-4  lg:flex lg:w-2/4 lg:items-center lg:justify-center lg:px-0 lg:pt-20 ">
            <form onSubmit={signIn} className="rounded-md border px-6 py-12 shadow-md">
              ...
              <div className="relative mt-4 py-6">
                <input name="password" value={form.password} onChange={handleChange} type="password" placeholder="Masukan Password Anda" className="w-full rounded-md border py-2 pl-20 focus:outline-none" />
