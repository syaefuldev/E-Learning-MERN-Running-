      ...
      <section id="register">
        <div className="flex w-full flex-col-reverse lg:flex-row-reverse lg:items-center lg:justify-between">
          <div className="h-screen px-4 pt-4  lg:flex lg:w-2/4 lg:items-center lg:justify-center lg:px-0 lg:pt-32 ">
            <form className="rounded-md border px-6 py-10 shadow-md">
              ...
              <div className="relative mb-6">
                <input type="text" placeholder="Masukan Nama Lengkap" className="w-full rounded-md border py-2 pl-20 focus:outline-none" />
                <i className="fa-solid fa-user absolute left-2 top-1 border-r-2 px-4 text-2xl text-base-400"></i>
              </div>
              <div className="relative mb-6">
                <input type="text" placeholder="Masukan Username Anda" className="w-full rounded-md border py-2 pl-20 focus:outline-none" />
                <i className="fa-solid fa-user absolute left-2 top-1 border-r-2 px-4 text-2xl text-base-400"></i>
              </div>
